...
class PostControllerTest extends TestCase {
    ...
    public function testCreatePostSuccess() {
        ...
        $this->assertDirectoryExists('/app/public/storage/pet_images/p' . $pet_id);

        // Cleanup
        File::deleteDirectory('/app/public/storage/pet_images/p' . $pet_id);
        $this->assertDirectoryDoesNotExist('/app/public/storage/pet_images/p' . $pet_id);
        Pets::where('name', $this::$TEST_CREDENTIALS['name'])->delete();
    }
