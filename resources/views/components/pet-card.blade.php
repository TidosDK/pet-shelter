        ...
        <div class="col">
            <div class="card">
                <div style="transform: rotate(0);">
	                ...
	                @endif
	                <div class="card-body">
	                    <h4 class="card-title"><a href="/pet/{{ $pet->id }}" class="text-decoration-none text-dark stretched-link">{{ $pet->name }}</a></h4>
	                    <hr>
	                    <p clasS="card-text mb-1"><strong>Months old: </strong>{{ $pet->age_in_months }}</p>
	                    <p class="card-text mb-1"><strong>Breed: </strong>{{ $breeds->find($pet->breeds_id)->breed }}</p>
