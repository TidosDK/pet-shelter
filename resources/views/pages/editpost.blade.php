            ...
            <div class="animal-info box">
                ...
                <div class="general-info right-box">
                    ...
                    <div class="form-floating form-list">
                        <select class="form-select" id="animalList" aria-label="Floating label select example"
                            name="type_id">
                            <option value="{{ $pet->type_id }}" selected>{{ $types->find($pet->type_id)->type }}
                            </option>
                    ...
                    <div class="form-check form-check-reverse">
                        <input class="form-check-input" type="checkbox" @if ($pet->multipleAnimalsFriendlyCheck) checked @endif
                ...
                <div class="outside-box">
                    <select class="form-select outside" id="breedList" aria-label="Default select example"
                        name="breeds_id">
                        <option value="{{ $pet->breeds_id }}" selected>{{ $breeds->find($pet->breeds_id)->breed }}
                        </option>
                    ...
                    <div class="input-group outside">
                        ...
                        <p>{{ $errors->first('price') }}</p>
                        <input type="text" aria-label="Price" id="price" class="form-control" name="price"
                            value="{{ $pet->price }}">
